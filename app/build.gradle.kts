...
android {
    ...
    namespace = "com.exory550.exorypad"

    defaultConfig {
        applicationId = "com.exory550.exorypad"
        minSdk = libs.versions.android.minSdk.get().toInt()
        targetSdk = libs.versions.android.targetSdk.get().toInt()

        versionCode = libs.versions.exorypad.versionCode.get().toInt()
        versionName = libs.versions.exorypad.versionName.get()

        resourceConfigurations.addAll(
            listOf(
                "en", "fr", "ko", "nl", "pl", "zh-rCN", "it", "de", "ru", "cs",
                "pt-rBR", "no", "zh-rTW", "ar", "tr", "el", "bn", "sw", "es", "ja", "in", "ms"
            )
        )
...
sqldelight {
    databases {
        create("Database") {
            packageName.set("com.exory550.exorypad.model")
